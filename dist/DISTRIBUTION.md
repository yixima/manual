...
| # | 配布先 | 貼るもの | 効く範囲 |
|---|---|---|---|
| 1 | claude.ai → 左下のイニシャル → 設定 →「Instructions for Claude」 | `L0_core_card_v18.md` の全文（文字数で入らなければ `L0_core_card_mini_v18.md`） | **すべての会話・すべてのプロジェクト** |
...
**`manual_v18_all_in_one.md` を、そのセッションに添付するだけ。**
