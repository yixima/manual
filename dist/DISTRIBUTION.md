...
| # | 配布先 | 貼るもの | 効く範囲 |
|---|---|---|---|
| 1 | claude.ai → 左下のイニシャル → 設定 →「Instructions for Claude」 | `L0_core_card_v53.md` の全文（文字数で入らなければ `L0_core_card_mini_v53.md`） | **すべての会話・すべてのプロジェクト** |
...
**`manual_v53_all_in_one.md` を、そのセッションに添付するだけ。**
...
`handover_template_v53.md` を使い、**一度に全部を思い出そうとせず、区切りのたびに同じファイルを作り直す**（§0-5）。
